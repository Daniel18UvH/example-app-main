...
return [
    ...
    | tales como las reglas de tamaño. Siéntete libre de ajustar cada mensaje.
    |
    */
    ...
    'array' => 'El campo :attribute debe ser un array (lista).',
    ...
    'password' => [
        ...
        'uncompromised' => 'El valor dado en :attribute ha aparecido en una filtración de datos. Por favor elige un :attribute diferente.',
    ],
    ...
    | rápido especificar una línea de idioma personalizada para una regla de atributo.
    |
    */
    ...
    | de atributo con algo más amigable para el lector como "Dirección de Correo"
    ...
    */
    ...
    'attributes' => [
        ...
        'password' => 'contraseña',
        // Puedes agregar más aquí si quieres que se vean bonitos en los errores
    ],
